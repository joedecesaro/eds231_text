...
Snow and danger together seems to have a lot more weather words than in the climbing data. When snow asscociation is removed from danger it seems to focus on risk and some other, more random words.
